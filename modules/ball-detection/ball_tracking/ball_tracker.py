...
from ball_tracking.models.tracknet.tracknet_tracker import TrackNetTracker
...
class BallTracker:
    ...
    def postprocess(
        self, positions: List[Tuple[Optional[float], Optional[float]]]
        ...
        Args:
            positions: Raw position data with possible outliers and missing values
