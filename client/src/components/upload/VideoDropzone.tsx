    ...
    return (
        <div
            ...
            className={cn(
                ...
                "w-full h-full p-16",
                "rounded-2xl shadow-lg border-6 border-dashed",
                "transition-all duration-200 cursor-pointer",
                "focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2",
                isDragActive
                    ? "border-primary bg-accent shadow-xl"
                    : "border-gray-400 bg-card hover:border-primary/70 hover:bg-accent/50 hover:shadow-xl",
                    ...
                    {isUploading && (
                        <div className="flex flex-col items-center space-y-2">
                            <div className="w-48 h-2 bg-gray-200 rounded-full overflow-hidden">
                                <div
                                    className="h-full bg-red-700 animate-pulse"
                                    style={{width: "100%"}}
                                />
                            </div>
                ...
                <div className="flex flex-col items-center space-y-6">
                    ...
                    <div className="text-center space-y-3">
                        <p className="text-xl font-semibold text-gray-900">
                            {isDragActive
                                ? "Drop video here"
                                : "Drag and drop your squash match video"}
                        </p>
                        <p className="text-sm text-gray-500">
                            or click to browse
                        </p>
