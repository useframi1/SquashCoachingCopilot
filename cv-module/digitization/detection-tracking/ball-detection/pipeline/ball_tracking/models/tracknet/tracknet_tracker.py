...
from ball_tracking.models.tracknet.model import BallTrackerNet
from ball_tracking.utils import postprocess, get_package_dir
...
class TrackNetTracker:
    ...
    def __init__(self, config: dict):
        ...
        model_path = get_package_dir() + "/" + model_path
