...
def get_package_dir():
    """Get the absolute path to the stroke_detection_pipeline package root"""
...
def prepare_features(
    ...
    """
    Convert keypoints sequence to feature array for model input
    ...
    Returns:
        numpy array of shape (1, window_size, num_features)
    """
