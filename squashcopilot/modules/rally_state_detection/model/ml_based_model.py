...
class MLBasedModel:
    ...
    def load_trained_model(self):
        ...
        # Get parent directory (rally_state_detection module root)
        parent_dir = get_package_dir(__file__).replace("/model", "")
        model_path = os.path.join(
            parent_dir, self.config["models"]["ml_based"]["model_path"]
        )
    ...
    def run_training_pipeline(
        self, data_path: str, test_size: float = 0.2, aggregated: bool = False
    ):
        """
